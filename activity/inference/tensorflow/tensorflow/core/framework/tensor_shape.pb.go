...
func (*TensorShapeProto) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/tensor_shape.proto", fileDescriptor6) }
